        ...
        <AnimatePresence mode="wait" custom={pageDirection}>
          ...
          {activePage === 'home' && (
            ...
            >
              ...
              <section id="hero" className="relative w-full min-h-[calc(100vh-10rem)] flex items-center justify-center overflow-hidden bg-gradient-to-b from-white via-[#f0f8fc] to-white py-10 lg:py-16">
                <div
                ...
                />
                <div className="absolute top-0 right-1/4 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-[#00f2fe]/20 via-[#0077c8]/15 to-transparent blur-3xl pointer-events-none animate-float-slow" />
                <div className="absolute -bottom-20 left-10 w-[550px] h-[550px] rounded-full bg-gradient-to-tr from-[#7c3aed]/12 via-[#00f2fe]/10 to-transparent blur-3xl pointer-events-none" />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                  <div className="lg:col-span-6 space-y-6 sm:space-y-7 text-left">
                    <motion.div
                      ...
                      className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-white shadow-xs border border-[#d4e8f5] text-[#0077c8] text-xs font-bold tracking-wide"
                    >
                      <SpiherStarburstLogo size={22} />
                    ...
                    <div className="space-y-3">
                      <motion.h1
                        ...
                        className="text-5xl sm:text-7xl xl:text-8xl font-serif font-black tracking-tight text-[#001f4d] leading-[1.05]"
                      >
                        RADIANZA <span className="text-[#0077c8]">'26</span>
                      </motion.h1>
                      ...
                      <motion.p
                        ...
                        className="text-xs sm:text-sm font-mono font-bold tracking-[0.22em] text-[#002b66] uppercase"
                      >
                        NATIONAL-LEVEL TECHNICAL SYMPOSIUM
                      </motion.p>
                    ...
                    <motion.div
                      ...
                      className="flex flex-wrap items-center gap-3 pt-1 text-xs font-semibold text-slate-700"
                    >
                    ...
                    >
                      <div className="relative group">
                        ...
                        <button
                          type="button"
                          onClick={onStartNewRegistration}
                          className="relative px-9 py-4 rounded-2xl bg-gradient-to-r from-[#001f4d] via-[#002b66] to-[#0077c8] text-white font-bold text-sm tracking-wide shadow-xl flex items-center justify-center gap-2.5 overflow-hidden cursor-pointer active:scale-95 transition-transform"
                        >
                      ...
                      <button
                        ...
                        className="px-8 py-4 rounded-2xl bg-white hover:bg-[#f0f8fc] border-2 border-[#d4e8f5] hover:border-[#0077c8] text-[#002b66] font-bold text-sm tracking-wide shadow-xs flex items-center justify-center gap-2 transition-all cursor-pointer active:scale-95"
                      >
                  ...
                  {/* 3D Cyber Head */}
                  <div className="lg:col-span-6 flex items-center justify-center relative w-full min-h-[460px] sm:min-h-[560px] overflow-visible">
